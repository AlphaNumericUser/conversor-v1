...
class StorageUnitOutput extends ConsumerWidget {
  const StorageUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(storageValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(storageSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
