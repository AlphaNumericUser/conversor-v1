...
class FuerzaUnitInput extends ConsumerWidget {
  const FuerzaUnitInput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final fuerzaController = ref.watch(fuerzaControllerProvider);

    void handleInputChange(String value) {
      if (value.isNotEmpty) {
        try {
          double valorNumerico = double.parse(value);
          ref.read(fuerzaValorNumericoProvider.notifier).cambiarValor(valorNumerico);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ref.read(fuerzaEntradaProvider.notifier).actualizarValor(value);
                      }
                    },
                  ),
                ),
