...
class TemperatureUnitOutput extends ConsumerWidget {
  const TemperatureUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(temperaturaValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(temperaturaSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
