...
class EnergiaUnitInput extends ConsumerWidget {
  const EnergiaUnitInput({
    Key? key,
  ...
  final List<Energia> lista;
  final double fontSize;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final energiaController = ref.watch(energiaControllerProvider);

    void handleInputChange(String value) {
      if (value.isNotEmpty) {
        try {
          double valorNumerico = double.parse(value);
          ref.read(energiaValorNumericoProvider.notifier).cambiarValor(valorNumerico);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ref.read(energiaEntradaProvider.notifier).actualizarValor(value);
                      }
                    },
                  ),
                ),
