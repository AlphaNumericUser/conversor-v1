...
class EnergiaUnitOutput extends ConsumerWidget {
  const EnergiaUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(energiaValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(energiaSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
