...
class PoderUnitOutput extends ConsumerWidget {
  const PoderUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(poderValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(poderSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
