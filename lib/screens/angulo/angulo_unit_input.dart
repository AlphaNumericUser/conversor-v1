...
class AnguloUnitInput extends ConsumerWidget {
  const AnguloUnitInput({
    Key? key,
  ...
  final List<Angulo> lista;
  final double fontSize;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final anguloController = ref.watch(anguloControllerProvider);

    void handleInputChange(String value) {
      if (value.isNotEmpty) {
        try {
          double valorNumerico = double.parse(value);
          ref.read(anguloValorNumericoProvider.notifier).cambiarValor(valorNumerico);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        ref.read(anguloEntradaProvider.notifier).actualizarValor(value);
                      }
                    },
                  ),
                ),
