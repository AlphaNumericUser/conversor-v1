...
class AnguloUnitOutput extends ConsumerWidget {
  const AnguloUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(anguloValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(anguloSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
