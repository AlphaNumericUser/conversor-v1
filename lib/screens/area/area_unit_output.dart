...
class AreaUnitOutput extends ConsumerWidget {
  const AreaUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(areaValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(areaSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
