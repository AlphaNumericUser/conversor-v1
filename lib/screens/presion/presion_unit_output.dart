...
class PresionUnitOutput extends ConsumerWidget {
  const PresionUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(presionValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(presionSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
