...
class WeightUnitOutput extends ConsumerWidget {
  const WeightUnitOutput({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final valorOutput = ref.watch(pesoValorOutputProvider);
              ...
              child: Center(
                child: Padding(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    onChanged: (value) {
                      ref.read(pesoSalidaProvider.notifier).actualizarValor(value!);
                    },
                  ),
                ),
              ),
